...
class ScaffoldCrudController extends Controller
{

      private $crud;
      private $fields = [
        'excluded' => [
          'form' => ['created_at', 'deleted_at', 'updated_at', 'id', '_id', 'remember_token'],
      ...
      public function __construct(Request $request)
      {
        ...
        $this->crud = [
          ...
          'name' => $uri[0],
          'fields' => $this->fields,
          'method' => array_get(['create' => 'POST', 'edit' => 'PUT'], $action),
        ];
      ...
      public function index(Request $request)
      {
        ...
        return view('scaffold_crud.index', [
          'rows' => DB::table($this->crud['name'])->paginate(15)
        ]);
      }
      ...
      public function create()
      {
        ...
        return view('scaffold_crud.form');
      }
      ...
      {
        $fillable_name_fields = array_pluck($this->crud['fields']['fillable'], 'Field');
      ...
      public function show()
      {
        ...
        return view('scaffold_crud.show');
      }
      ...
      {
          $data = $request->only(array_pluck($this->fields['fillable'], 'Field'));
          /*
